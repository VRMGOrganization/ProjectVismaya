...
import net.sourceforge.ganttproject.gui.GanttTaskPropertiesBean.SizeProperties.Sizes;
...
//Edited here
      if(barField.getSelectedIndex()== 2)
      {
    	  Barsize1=15;

      }
      else if(barField.getSelectedIndex()==0)
      {
    	  Barsize1=5;
      }
      else if(barField.getSelectedIndex()==1)
      {
    	  Barsize1=12;
      }
      Sizes selectedSize = (Sizes) barField.getSelectedItem();
