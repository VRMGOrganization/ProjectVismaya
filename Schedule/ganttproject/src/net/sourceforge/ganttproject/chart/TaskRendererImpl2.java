...
import net.sourceforge.ganttproject.gui.GanttTaskPropertiesBean; 
...
public class TaskRendererImpl2 extends ChartRendererBase {
  ...
  class TaskActivityChartApi implements TaskActivitySceneBuilder.ChartApi {
    ...
    public int getBarHeight() {
      return myBarHeight+GanttTaskPropertiesBean.Barsize1; // Editing For Row Height....
    }
    @Override
  ...
  private int getRowHeight() {
    return calculateRowHeight();//+GanttTaskPropertiesBean.Barsize1;
  }
